      ...
      <div className="">
            ...
            <div className="flex-1 flex-col py-6 justify-center flex  md:pr-24">
              <div className="">
                ...
                <h1
                  ...
                  data-aos-delay="500"
                >
                  Eagle Capital is a distinguished M&A and investment firm with
                  a strategic focus on secure investments within South Eastern
                  Europe and the United States. Our primary investment targets
                  are licensed financial institutions, prime real estate in
        ...
        <div className=" bg-primary text-white py-24 space-y-24">
          <div className="page-container mx-auto px-3  text-sm">
            <div className="grid md:grid-cols-1 justify-center items-center text-center gap-8">
              <div className="flex flex-col justify-between">
                <div>
                  <h1 className="text-4xl">Our current investments</h1>
                  <p className="text-base py-5 max-w-full md:max-w-[50%] mx-auto text-center">
                    Eagle Capital actively pursues a diverse portfolio of
                    investments across our strategic focus areas. Our commitment
                    to achieving high returns is demonstrated through our
                    carefully selected current investments in financial
                    institutions, prime real estate, and renewable energy
                    projects.
                  </p>
                </div>
              </div>
        ...
        <div className=" bg-slate-100">
          <div className="page-container mx-auto px-3 py-24 text-sm">
            <div className="grid relative  pl-20 justify-between gap-8">
              <h1 className="text-3xl absolute top-0 left-0 -translate-y-9  rotate-90 origin-bottom-left">
                Investment Strategy
              </h1>
              <div className="space-y-12">
                <div className="space-y-5">
                  ...
                  >
                    ...
                    <p>
                      Real Estate: Acquiring and developing prime real estate in
                      prestigious coastal areas, focusing on properties that
                      offer both luxury and exclusivity.
                    </p>
                    <p>
                      Renewable Energy: Committing to environmental
                      sustainability by investing in renewable energy projects,
                      including solar, wind, and hydroelectric power
                      developments, that promise high efficiency and lower
                ...
                <div className="space-y-5">
                  ...
                  >
                    <p>
                      ...
                      identify and exploit investment opportunities ahead of the
                      curve
                    </p>
                    <p>
                      United States: In the US, our strategy is twofold,
                      focusing on both the robust financial sector and
                      high-value real estate markets along the East Coast,
