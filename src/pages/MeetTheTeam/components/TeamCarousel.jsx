      ...
      <div className="page-container ">
        <div className="py-24">
          ...
          <div className="relative w-full ">
            ...
            <div ref={carouselRef} className="flex overflow-x-scroll -mx-20 scroll-px-20 overflow-y-hidden  snap-x snap-mandatory scroll-smooth gap-24 no-scrollbar cursor-grab">
              {teamMembers.map((member, index) => (
                <>
                  <div className="flex-shrink-0 w-3/5 relative px-20 snap-center  flex  ">
            ...
            <div class="bg-gradient-to-r from-white absolute -mx-1 h-full top-0 -left-20 bottom-0 w-20"></div>
            <div class="bg-gradient-to-l from-white absolute -mx-1 h-full top-0 -right-20 bottom-0 w-20"></div>
          </div>
        </div>
      </div>
    </div>
